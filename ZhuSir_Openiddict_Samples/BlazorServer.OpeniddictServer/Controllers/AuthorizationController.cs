...
using BlazorServer.OpeniddictServer.Helpers;
using BlazorServer.OpeniddictServer.ViewModels.Authorization;
...
namespace BlazorServer.OpeniddictServer.Controllers
{
